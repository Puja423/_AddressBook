...
--View table details
select * from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'Address_Book1';
--Add Contacts
...
('Kaminee','Uikey','Manit','Bhopal','Madhya Prdaesh','547856','565327645','kammo@gmail.com'),
('Rani','Ahirwar','Sagar','Bhopal','Uttar Pradesh','658927','9424787845','ranipagal@gmail.com'),
('Rakhi','Saraf','sitamarhi','pupri','Bihar','125463','9844022925','rakhi02@gmail.com');
--View AddressBook
...
select COUNT(City), City, State from Address_Book1
group by State, City;
...
select Contact_Type, COUNT(Contact_Type) from Address_Book1
